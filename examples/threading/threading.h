 ...
 */
struct thread_data{
    /** Mutex this thread must lock after wait_to_obtain_ms, then unlock after wait_to_release_ms. */
    pthread_mutex_t *mutex;
    /** Milliseconds to sleep before calling pthread_mutex_lock. */
    int wait_to_obtain_ms;
    /** Milliseconds to sleep while holding the mutex, before pthread_mutex_unlock. */
